        ...
        <div className="">
          ...
          <ol>
            <li>
              ...
              amount shall be due and payable in advance on the first day of
              each month. Upon signing of this contract, you are providing
              payment for the first and last month.{" "}
            </li>
            <li>
              In order to protect the parking rights of all tenants at this
              property the parking lot will be monitored and parking controls
              will be strictly enforced.
            </li>
            <li>
              Any vehicle without a valid decal displayed in the designated
              location will be ticketed as being illegally parked and may be
              towed away at owner's expense and risk.
            </li>
            <li>
              Either party can terminate this rental of parking/storage space
              upon thirty (30) days written notice delivered by ordinary mail or
              by fax at the address shown above.{" "}
            </li>
            <li>
              Theft will not be tolerated. Tenants found removing items from
              other properties will be subject to prosecution. This activity
              will result in immediate termination of this contract and/or any
              other privileges.{" "}
            </li>
            <li>
            ...
            <li>
              The charges are for use of parking spaces only. We have no
              liability to you or to any other person for any loss, theft, fire,
              damage, injury or death caused by you, or to you, in the use of
              parking space. You shall indemnify and save us from harmless from
              and against any and all claims, demands, liabilities, losses,
              costs, damages and expenses which may be suffered or incurred by
              us arising from any damage to or loss of property or injury or
              death of any person arising from your use of parking space.{" "}
            </li>
            <li>
            ...
            <li>
              ...
              Name) relating to your rental of the parking space and there are
              no collateral, implied, or express terms which are not stated in
              this contract.
            </li>
            <li>
            ...
            <li>
              Sub-Letting is not permitted. The activity will result in
            ...
            <li>
              ...
              until the total balance is cleared, and may result in a
              termination of this contract.
            </li>
            <li>
              This parking contract shall be governed by the laws of the
              Province of Ontario
            </li>
          </ol>
        </div>
