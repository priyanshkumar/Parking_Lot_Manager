    ...
    return (
      <div>
        ...
        <p>
          ...
          payable in advance on the first day of each month. Uponsigning of this
          contract, you are providing payment for the first and last month.{" "}
          <br />
          ...
          designated location will be ticketed as beingillegally parked and may
          be towed away at owner's expense and risk.
          ...
          fromany damage to or loss of property or injury or death of any person
          arising from your use of parkingspace. <br />
          8. Non payment for sixty (60) days will be handed over to collections
          for legal action.
          <br />
        </p>
        <p>
          ...
          consent of us.
          <br />
          10. You will not carry out any repairs to your vehicle, including any
          draining or filling of fluids for thevehicle on the property. You will
          not permit any deposit or dumping of any fluids on to the property.You
          will not suffer or permit the storage, discharge or disposal of any
          contaminant or waste,flammable, explosive, radioactive, corrosive or
          poisonous material or substance or pollution or anyother
          environmentally hazardous, dangerous or noxious substances or
          materials including but notlimited to those declared or determined by
          the standards established by relevant governmental status,by-laws, or
          regulations to be hazardous or toxic.
          <br />
          ...
          thiscontract.
          <br />
          12. You will remove your vehicle upon the termination of this contract
          within 24 hours.
          <br />
          ...
          <br />
          15. All returned cheques/checks (N.S.F.) will result in an additional
          $50.00 surcharge and yourequipment will not move this premises until
          the total balance is cleared, and may result in atermination of this
          contract.
          <br />
